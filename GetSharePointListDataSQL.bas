...
'   Dim GSPD as New GetSharePointListDataSQL
...
Public Property Let addSharePointList(url As String, listID As String, listName, sql As String)
...
Sub GetSharePointListData()
    ...
    For j = 0 To UBound(urls)
        ...
        rst.Open Msql, cnt, adOpenDynamic, adLockOptimistic
